"""
Contexto e instruções para a IA na análise de requisitos.
"""
...
def _formatar_contexto(payload: dict) -> str:
    ...
    if payload.get("ha_contorno") is not None:
        linhas.append(f"• Há contorno/workaround: {'sim' if payload['ha_contorno'] else 'não'}")
